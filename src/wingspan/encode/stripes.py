...
def card_feature_stripe_layout() -> VectorLayout:
    ...
    return VectorLayout(total_size=total, stripes=stripes)


def hand_encoder_input_stripe_layout() -> VectorLayout:
...
def _card_attr_sub_fields() -> tuple[SubFieldDescriptor, ...]:
