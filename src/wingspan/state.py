...
class PlayedBird:
    ...
    activations: int = 0
    # Round index in which this PINK between-turn power last fired. The
    # sentinel ``-1`` means "not yet this game"; the engine enforces the
    # once-per-round guard by comparing against ``state.round_idx``.
